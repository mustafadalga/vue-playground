...
const selectedOptions = ref<IOption[]>(userInformation.value.languages.map(option => ({
    id: option,
    value: option,
    checked: true
})));
...
function next() {
    store.mutations.setLanguages(selectedOptions.value.map(language => language.id));
...
<template>
    <section class="flex flex-col h-full">
        <slot title="Languages" :icon="IconTranslate"/>
